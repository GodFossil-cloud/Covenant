...
(function () {
    ...
    window.COVENANT_JOURNEY = [
        ...
        { id: 'I', title: 'Article I: Of Sacred Silence', href: 'I.html' },
        { id: 'II', title: 'Article II: Of Titles and Forms of Address', href: 'II.html' },
        { id: 'III', title: 'Article III: Of the Duties of the Faithful', href: 'III.html' },
        { id: 'IV', title: 'Article IV: Of the Duties of the Lord', href: 'IV.html' },
        { id: 'V', title: 'Article V: Of Interdependence and Mutual Consecration', href: 'V.html' },
        { id: 'VI', title: 'Article VI: Of Ceremonial and Symbolic Boundaries', href: 'VI.html' },
        { id: 'VII', title: 'Article VII: Of Interpretation and Counsel', href: 'VII.html' },
        { id: 'VIII', title: 'Article VIII: Of Commands and Their Execution', href: 'VIII.html' },
        { id: 'IX', title: 'Article IX: Of Appeals and Resolution', href: 'IX.html' },
        { id: 'X', title: 'Article X: Of Transgression, Correction, and Reconciliation', href: 'X.html' },
        { id: 'XI', title: 'Article XI: Of Amendments and Renewal', href: 'XI.html' },
        { id: 'XII', title: 'Article XII: Of Suspension, Succession, and Termination', href: 'XII.html' },
